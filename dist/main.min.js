(function () {
  ...
  var fetchAuthConfig = function fetchAuthConfig() {
  ...
  regeneratorRuntime.mark(function _callee3() {
    var login, logout, loginBtn, logoutBtn, query;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 2:
            ...
            loginBtn.addEventListener('click', login); // logout button

            logoutBtn = document.getElementById('logout');
            logoutBtn.addEventListener('click', logout); // 登入後的當下，把網址中的參數替換掉
  ...
  function () {
    ...
    regeneratorRuntime.mark(function _callee4() {
      var isAuthenticated, accessToken, user, loginWrap, cardWrap, emailVerify, card;
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 9:
              ...
              console.log(user); // 隱藏登入區塊

              loginWrap = document.querySelector('.card-wrap.log');
              loginWrap.classList.add('d-none'); // 打開卡片區塊

              cardWrap = document.querySelector('.card-wrap.logged');
              cardWrap.classList.remove('d-none');
              user.email_verified ? emailVerify = '已驗證' : emailVerify = '尚未驗證';
              card = "\n      <div class=\"card\">\n\n        <div class=\"alert text-center\">\n          <img src=\"".concat(user.picture, "\">\n          <h2>").concat(user.nickname, "</h2>\n        </div>\n\n        <div class=\"info\">\n          <p>\u8A3B\u518A\u4FE1\u7BB1\uFF1A").concat(user.email, "</p>\n          <p>\u4FE1\u7BB1\u662F\u5426\u9A57\u8B49\uFF1A").concat(emailVerify, "</p>\n          <p>\u4EE4\u724C Token\uFF1A").concat(accessToken, "</p>\n          <h6>\u6700\u5F8C\u66F4\u65B0\u6642\u9593\uFF1A").concat(user.updated_at, "</h6>\n        </div>\n\n      </div>\n    ");
              cardWrap.insertAdjacentHTML('afterbegin', card);
              _context4.next = 23;
              break;

            case 22:
              console.log('未登入'); // 未登入時，要做什麼
